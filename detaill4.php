...
<section class="detail-card">
    ...
    <li class="sub-list">
        ...
        <h3>Biaya</h3>
        <p>Biaya beban untuk <strong>pengurusan paspor karena keadaan kahar adalah Rp0,-,</strong>sesuai dengan Peraturan Menteri Keuangan (Permenkeu) Nomor 51/PMK.02/2020. </p>
    </div>
